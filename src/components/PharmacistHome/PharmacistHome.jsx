  ...
  async function getMedicineList(id) {
    ...
    try {
      ...
      if (response.status === 200 && response.data) {
        ...
        setMedicineList({ prescriptions: [] });
      }
    } catch (error) {
      console.log("error", error);
      setMedicineList({ prescriptions: [] });
      toast.error("No prescriptions found for this ID");
    } finally {
      setIsLoading(false);
    }
  }
          ...
          <div className="pharmacistHomeContainer pb-5">
            <div className="pharmacy-info container mx-auto my-4 p-4">
              <h1 className="display-3-md mx-2 mb-5">
                ...
                {pharmacistProfile?.pharmacy_name || "Pharmacy"}
              </h1>
              ...
              <div className="col-md-6">
                ...
                {isLoading ? (
                  ...
                  <button
                    ...
                    onClick={() => getMedicineList(inputValue)}
                  >
          ...
          <div className="my-5 prescriptionList">
            ...
            >
              {medicineList ? (
                ...
                medicineList.prescriptions.length > 0 ? (
                  medicineList.prescriptions.map((item, index) => (
                    <div
                      className="accordion-item"
                      key={
                        item.id || `${item.doctor}-${item.created_at}-${index}`
                      }
                    >
                  ...
                  <p className="text-muted p-3">
                    No prescriptions found for this ID.
                  </p>
                )
              ) : (
                ""
